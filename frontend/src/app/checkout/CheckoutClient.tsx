...
import { CheckCircle2, CreditCard, Minus, Plus, XCircle } from "lucide-react";
...
export function CheckoutClient({ event }: { event: Event }) {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1fr_380px]">
          ...
          <div className="flex flex-col justify-between gap-4 rounded-md bg-background p-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {event.availableTickets} ingresso{event.availableTickets === 1 ? "" : "s"} disponível
      ...
      <aside className="h-fit rounded-lg border border-surface-2 bg-surface p-5">
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-3 border-y border-surface-2 py-4 text-sm">
            <div className="flex items-center justify-between gap-4">
              ...
              <span className="font-bold text-text">{quantity} x {formatCurrency(event.price)}</span>
            </div>
            <div className="flex items-center justify-between gap-4">
          ...
          <div className="rounded-md border border-surface-2 bg-background p-4">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Use os botões abaixo para demonstrar os dois estados do PaymentModule.
            </p>
          </div>
